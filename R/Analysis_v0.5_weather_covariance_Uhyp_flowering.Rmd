...
How many SNP effects load onto each covariance matrix?
```{r}
gulfm <- readRDS("~/Github/pvdiv-phenology-gxe/analysis/mash/Gulf/Strong_Effects19000SNPs_FL50_Gulf.rds")
midwm <- readRDS("~/Github/pvdiv-phenology-gxe/analysis/mash/Midwest/Strong_Effects33000SNPs_FL50_Midwest.rds")
