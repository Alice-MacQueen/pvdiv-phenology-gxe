...
How many SNP effects load onto each covariance matrix?
```{r}
gulfm <- readRDS("~/Github/pvdiv-phenology-gxe/analysis/gwas/BLUPs/single_sites/Strong_Effects19000SNPs_FL50_Gulf.rds")
midwm <- readRDS("~/Github/pvdiv-phenology-gxe/analysis/gwas/BLUPs/single_sites/Strong_Effects33000SNPs_FL50_Midwest.rds")
gandm <- readRDS("~/Github/pvdiv-phenology-gxe/analysis/gwas/BLUPs/single_sites/Strong_Effects19000SNPs_FL50_Gulf_and_Midwest.rds")
```
