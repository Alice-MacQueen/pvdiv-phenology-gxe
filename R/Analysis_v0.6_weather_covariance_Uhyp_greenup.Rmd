...
get_pw_filtered(m_gulf_gr_hyp, pw_thresh = 0.1, BF_thresh = 2) %>% 
...
Both FL: 2 SNPs        dyln_change_sec_Midwest

Gulf FL: 0 SNPs
Gulf GR: 11 & 2 SNPs   cgdd_12c_18d_Gulf_and_Midwest.10 & tave_18d_Gulf_and_Midwest.6

Midw GR: 0 SNPs
Midw FL: 11 SNPs       cgdd_12c_gr2fl_Gulf_and_Midwest
...
gg_annos <- pw_gg %>% 
  filter((cgdd_12c_18d_Gulf_and_Midwest.10 > .1 | tave_18d_Gulf_and_Midwest.6 > 0.1) & log10BayesFactor > 2) %>%
  mutate(CHR = Chr,
