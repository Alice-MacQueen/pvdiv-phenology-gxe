...
mash_plot_svd <- function(m, i = NULL, eigen_v = 1){
  ...
  if(eigen_v == 1){
    ylab <- paste0("First eigenvector (PVE = ", eval(round(b1_df$PVE_EV[1]*100,1)), "%)")
  } else if(eigen_v == 2){
    ylab <- paste0("Second eigenvector (PVE = ", eval(round(b1_df$PVE_EV[1]*100,1)), "%)")
  } else if(eigen_v == 3){
    ylab <- paste0("Third eigenvector (PVE = ", eval(round(b1_df$PVE_EV[1]*100,1)), "%)")
  } else if(eigen_v == 4){
    ylab <- paste0("Fourth eigenvector (PVE = ", eval(round(b1_df$PVE_EV[1]*100,1)), "%)")
  } else if(eigen_v == 5){
    ylab <- paste0("Fifth eigenvector (PVE = ", eval(round(b1_df$PVE_EV[1]*100,1)), "%)")
  }
  ggb1 <- b1_df %>%
...
f3c <- mash_plot_pairwise_sharing(corrmatrix = gxe_gg$S_AP, reorder = FALSE)
f3d <- mash_plot_pairwise_sharing(corrmatrix = gxe_gg$S_DS, reorder = FALSE)
f3g <- mash_plot_pairwise_sharing(corrmatrix = gxe_mg$S_AP, reorder = FALSE)
f3h <- mash_plot_pairwise_sharing(corrmatrix = gxe_mg$S_DS, reorder = FALSE)
f3k <- mash_plot_pairwise_sharing(corrmatrix = gxe_gamg$S_AP, reorder = FALSE)
f3l <- mash_plot_pairwise_sharing(corrmatrix = gxe_gamg$S_DS, reorder = FALSE)
f3o <- mash_plot_pairwise_sharing(corrmatrix = gxe_gf$S_AP, reorder = FALSE)
f3p <- mash_plot_pairwise_sharing(corrmatrix = gxe_gf$S_DS, reorder = FALSE)
f3s <- mash_plot_pairwise_sharing(corrmatrix = gxe_mf$S_AP, reorder = FALSE)
f3t <- mash_plot_pairwise_sharing(corrmatrix = gxe_mf$S_DS, reorder = FALSE)
f3w <- mash_plot_pairwise_sharing(corrmatrix = gxe_gamf$S_AP, reorder = FALSE)
f3x <- mash_plot_pairwise_sharing(corrmatrix = gxe_gamf$S_DS, reorder = FALSE)
```
...
```{r}
ggdraw() +
  draw_plot(f3a, x = 0, y = 0.825, width = 0.33, height = 0.175) +
  draw_plot(f3b, x = 0, y = 0.65, width = 0.33, height = 0.175) +
  draw_plot(f3d$gg_corr, x = 0.165, y = 0.5, width = 0.165, height = 0.15, scale = 2) +
  draw_plot(f3c$gg_corr, x = 0, y = 0.5, width = 0.165, height = 0.15, scale = 2) +
  draw_plot(f3e, x = 0.33, y = 0.825, width = 0.33, height = 0.175) +
  draw_plot(f3f, x = 0.33, y = 0.65, width = 0.33, height = 0.175) +
  draw_plot(f3h$gg_corr, x = 0.165+.33, y = 0.5, width = 0.165, height = 0.15, scale = 2) +
  draw_plot(f3g$gg_corr, x = 0+.33, y = 0.5, width = 0.165, height = 0.15, scale = 2)  +
  draw_plot(f3i, x = 0.66, y = 0.825, width = 0.33, height = 0.175) +
  draw_plot(f3j, x = 0.66, y = 0.65, width = 0.33, height = 0.175) +
  draw_plot(f3l$gg_corr, x = 0.165+.66, y = 0.5, width = 0.165, height = 0.15, scale = 2) +
  draw_plot(f3k$gg_corr, x = 0+.66, y = 0.5, width = 0.165, height = 0.15, scale = 2) +  ## greenup above here, flowering below
  draw_plot(f3m, x = 0, y = 0.825-0.5, width = 0.33, height = 0.175) +
  draw_plot(f3n, x = 0, y = 0.65-0.5, width = 0.33, height = 0.175) +
  draw_plot(f3p$gg_corr, x = 0.165, y = 0.5-0.5, width = 0.165, height = 0.15, scale = 2) +
  draw_plot(f3o$gg_corr, x = 0, y = 0.5-0.5, width = 0.165, height = 0.15, scale = 2) +
  draw_plot(f3q, x = 0.33, y = 0.825-0.5, width = 0.33, height = 0.175) +
  draw_plot(f3r, x = 0.33, y = 0.65-0.5, width = 0.33, height = 0.175) +
  draw_plot(f3t$gg_corr, x = 0.165+.33, y = 0.5-0.5, width = 0.165, height = 0.15, scale = 2) +
  draw_plot(f3s$gg_corr, x = 0+.33, y = 0.5-0.5, width = 0.165, height = 0.15, scale = 2)  +
  draw_plot(f3u, x = 0.66, y = 0.825-0.5, width = 0.33, height = 0.175) +
  draw_plot(f3v, x = 0.66, y = 0.65-0.5, width = 0.33, height = 0.175) +
  draw_plot(f3x$gg_corr, x = 0.165+.66, y = 0.5-0.5, width = 0.165, height = 0.15, scale = 2) +
  draw_plot(f3w$gg_corr, x = 0+.66, y = 0.5-0.5, width = 0.165, height = 0.15, scale = 2)

save_plot(filename = "Figure_3_Data_driven_Covariance_matrices.png", plot = last_plot(), base_height = 8, base_width = 9)
```
