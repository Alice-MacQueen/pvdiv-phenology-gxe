...
plot_covar_Ulist_fig2 <- function(df, mf = FALSE, mg = FALSE) {
  if (mg) {
    df <- df %>%
...
save_plot(filename = "../manuscript/Coauthors/PNAS/Revision/Figure_2_Covariance_matrices_and_posterior_weights.svg", plot = last_plot(), base_height = 6, base_width = 8.5)
```
...
```{r}
get_gxe_summary(gxe_gg) 
get_gxe_summary(gxe_mg, n_cond = 7) 
get_gxe_summary(gxe_gamg, n_sep = 4) 
print("flowering")
get_gxe_summary(gxe_gf) 
get_gxe_summary(gxe_mf, n_cond = 6) 
get_gxe_summary(gxe_gamf, n_sep = 4) 
```
...
```{r}
p3legend <- pvdiv_plot_cor(corrmatrix = gxe_gg$S_AP, legend = TRUE, upper = 4333) + 
  labs(title = "Gulf", subtitle = "Sign difference")
legend <- get_legend(p3legend)

p3a1 <- pvdiv_plot_cor(corrmatrix = gxe_gg$S_AP, legend = FALSE, upper = 4333) + 
  labs(subtitle = " ")
p3a2 <- pvdiv_plot_cor(corrmatrix = gxe_gg$S_DS, legend = FALSE, upper = 4333) + 
  labs(subtitle = " ")
p3a3 <- pvdiv_plot_cor(corrmatrix = gxe_gg$S_2_no, legend = FALSE, upper = 4333) + 
  labs(subtitle = " ")
p3b1 <- pvdiv_plot_cor(corrmatrix = gxe_mg$S_AP, legend = FALSE, upper = 4333) + 
  labs(subtitle = "Sign difference")
p3b2 <- pvdiv_plot_cor(corrmatrix = gxe_mg$S_DS, legend = FALSE, upper = 4333) + 
  labs(subtitle = "Magnitude difference")
p3b3 <- pvdiv_plot_cor(corrmatrix = gxe_mg$S_2_no, legend = FALSE, upper = 4333) + 
  labs(subtitle = "Not distinguishable")
p3c1 <- pvdiv_plot_cor(corrmatrix = gxe_gamg$S_AP, legend = FALSE, upper = 4333) + 
  labs(subtitle = " ")
p3c2 <- pvdiv_plot_cor(corrmatrix = gxe_gamg$S_DS, legend = FALSE, upper = 4333) + 
  labs(subtitle = " ")
p3c3 <- pvdiv_plot_cor(corrmatrix = gxe_gamg$S_2_no, legend = FALSE, upper = 4333) + 
  labs(subtitle = " ")

p3d1 <- pvdiv_plot_cor(corrmatrix = gxe_gf$S_AP, legend = FALSE, upper = 4333) + 
  labs(subtitle = " ")
p3d2 <- pvdiv_plot_cor(corrmatrix = gxe_gf$S_DS, legend = FALSE, upper = 4333) + 
  labs(subtitle = " ")
p3d3 <- pvdiv_plot_cor(corrmatrix = gxe_gf$S_2_no, legend = FALSE, upper = 4333) + 
  labs(subtitle = " ")
p3e1 <- pvdiv_plot_cor(corrmatrix = gxe_mf$S_AP, legend = FALSE, upper = 4333) + 
  labs(subtitle = "Sign difference")
p3e2 <- pvdiv_plot_cor(corrmatrix = gxe_mf$S_DS, legend = FALSE, upper = 4333) + 
  labs(subtitle = "Magnitude difference")
p3e3 <- pvdiv_plot_cor(corrmatrix = gxe_mf$S_2_no, legend = FALSE, upper = 4333) + 
  labs(subtitle = "Not distinguishable")
p3f1 <- pvdiv_plot_cor(corrmatrix = gxe_gamf$S_AP, legend = FALSE, upper = 4333) + 
  labs(subtitle = " ")
p3f2 <- pvdiv_plot_cor(corrmatrix = gxe_gamf$S_DS, legend = FALSE, upper = 4333) + 
  labs(subtitle = " ")
p3f3 <- pvdiv_plot_cor(corrmatrix = gxe_gamf$S_2_no, legend = FALSE, upper = 4333) + 
  labs(subtitle = " ")
```
...
```{r}
sig_random <- readRDS(file = "../data/Random_QTL_df_FL50_significant_enrichments_of_mash_1per_tail_or_mash_BF2_tail_SNPs_1000runs.rds")
