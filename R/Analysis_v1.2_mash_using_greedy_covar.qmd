...
GWAS were run on BLUPs from models run at each garden individually. The GWAS were run in R/Plots_v0.3_manuscript_figures.Rmd, starting at line 1243. I copy-pasted that info here to have the full workflow in one qmd document; you may need to refer to it if you need additional information.
