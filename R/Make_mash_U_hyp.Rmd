...
U_hyp must be matrices. They must be symmetric, in the same order as Bhat etc, and with the same # rows and cols as Bhat etc.
...
mash_plot_Ulist(m, range = get_U_by_mass(m), saveoutput = TRUE, 
                  suffix = suffix)
