...
## 
```{r}
write_rds(cross, "../data/fourway_cross_data.rds", compress = "gz")
```
...
mash_plot_pairwise_sharing(corrmatrix = K[1:20,1:20])

write_rds(K, path = "~/Github/pvdiv-phenology-gxe/data/Kinship_van_Raden_750g_fourway_cross_withInbred.rds")
```
