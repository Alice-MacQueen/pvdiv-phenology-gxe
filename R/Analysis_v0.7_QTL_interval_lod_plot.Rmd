...
save_plot(filename = "../manuscript/Coauthors/PNAS/Revision/Figure_4_QTL_by_lod_score.svg", base_height = 3, base_width = 13.5, plot = last_plot())
```
...
save_plot(filename = "../manuscript/Coauthors/PNAS/Revision/Figure_4_QTL_by_lod_score_w_rugs.svg", base_height = 3, base_width = 13.5, plot = last_plot())
```
