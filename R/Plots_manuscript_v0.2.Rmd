...
gulf_qtl_overlap %>%
  arrange(desc(max_score_log10p))
```
How many SNPs are in the QTL regions? And how many SNPs are in the full genome? Therefore how many SNPs would we expect at random?
