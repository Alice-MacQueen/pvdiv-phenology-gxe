...
growth for Gulf genotypes (hereafter `green-up') occurred before
Midwestern green-up, and the onset of reproductive growth for Gulf
genotypes (hereafter `flowering') occurred after Midwestern flowering
...
(42). Third, to make the \emph{mash} models computationally feasible, we
extracted two subsets of SNP effect estimates and standard errors from
our GWAS effect estimates: 1) effects from a subset of ``strong'' tests
corresponding to stronger effects on our traits; 2) results from a
