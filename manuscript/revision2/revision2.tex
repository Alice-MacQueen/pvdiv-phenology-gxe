...
frequencies of various forms of GxE, particularly sign-changing GxE,
...
Appendix, Section S2) (36). We use the Bayesian framework \emph{mash}
...
across gardens (Figure~\ref{fig-map} D; SI Appendix, Datasets 1-6). We
...
SX). 78.7\% of pairwise comparisons between North and Texas gardens had
...
other gardens (SI Appendix, Fig SX). Similarly, more effects that
