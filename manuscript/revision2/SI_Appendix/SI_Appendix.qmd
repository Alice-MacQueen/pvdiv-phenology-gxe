...
Figures should be cross-referenced like @fig-qtl-by-env. Each figure should be on its own page. You can control this by placing a pagebreak shortcode, with `{{< pagebreak >}}`.
...
![Figure](figs/frog.eps){#fig-garden-by-garden-gxe}

\FloatBarrier <!-- always leave a blank line between this and figures --->

{{< pagebreak >}}

![Figure](figs/frog.eps){#fig-qtl-by-env}
