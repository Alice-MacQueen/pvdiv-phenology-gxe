...
multivariate adaptive shrinkage (mash {[}@urbut2018{]}) to determine the
regions of the switchgrass genome with different types of GxE,
specifically regions of the genome with effects on phenology that covary
with several weather-based `cues'. We use a greedy algorithm to compete
and select types of GxE and GxWeather that improve our models, then use
mash to identify which SNP effects are best modeled with each type of
GxE or GxWeather.
