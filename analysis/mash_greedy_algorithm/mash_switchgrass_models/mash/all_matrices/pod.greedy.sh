...
python run.mash.greedy.search.py -p greenup -c gulf -e strong
python run.mash.greedy.search.py -p greenup -c midwest -e strong
python run.mash.greedy.search.py -p greenup -c all -e strong
...
python run.mash.greedy.search.py -p flowering -c gulf -e strong
python run.mash.greedy.search.py -p flowering -c midwest -e strong
python run.mash.greedy.search.py -p flowering -c all -e strong
